...
public:
	...
	*/
	...
	void updateAeroForces(const double Cy_total, const double Cx_total, const double Cz_total, const double Cl_total, const double Cm_total, const double Cn_total)
	{
		...
		Vec3 cl_moment(Cl_total * wingPressureN * F16::wingSpan_FT, 0.0, 0.0);
		...
		Vec3 cm_moment(0.0, 0.0, Cm_total * wingPressureN * F16::meanChord_FT);
		...
		Vec3 cn_moment(0.0, -Cn_total * wingPressureN * F16::wingSpan_FT, 0.0);
